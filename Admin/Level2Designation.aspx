<%@ Page Title="" Language="C#" MasterPageFile="~/LumenApp.master" AutoEventWireup="true" CodeFile="Level2Designation.aspx.cs" Inherits="Admin_Level2" %>

<asp:Content ContentPlaceHolderID="Title" runat="server">
    <h2>Manage second level of hierarchy</h2>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server" >
    ...
    <!-- ########## THE GRID ######### -->
    <asp:GridView runat="server" ID="gridLevel2Desg" AutoGenerateColumns="false" 
    OnRowDataBound="gridLevel2Desg_RowDataBound" CssClass="mGrid" EmptyDataText="There are no records.">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Subordinates" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="125px"  Visible="false">
                <ItemTemplate>                                        
    ...
    <div class="AcePopup" id="editform" style="width:525px">
        ...
        <div style=" margin:0px -10px 0px -10px;">
            <h2 class="popupheader">Add/Edit second level of hierarchy</h2>
