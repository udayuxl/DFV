...
<asp:Content ID="Content4" ContentPlaceHolderID="cphMain" Runat="Server">
    <div class="GridButtons" style="width:900px;height:52px;border-bottom:1px solid gray;" runat="server" id="divProceedToOrder">
    ...
    <div class="GridButtons">              
        <div style="float:left;padding-left:10px;width:200px"  runat="server" id="divAddBtn" visible="true">
    ...
    <div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Address Owner" Visible="false">
                <ItemTemplate>
                    <asp:Literal ID="litUserName" Text="" runat="server"/>
                </ItemTemplate>
            </asp:TemplateField>     
            ...
            <asp:TemplateField SortExpression="Address1" HeaderText="Address" >
                <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hdnShippingInstructionId" runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField Visible="true"  HeaderText = "Shipping Instruction" > 
                <ItemTemplate>
