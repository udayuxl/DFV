<%@ Page Language="C#" MasterPageFile="~/LumenApp.master" AutoEventWireup="true" Title="Order Recap" CodeFile="DropShipList.aspx.cs" Inherits="Reports_ProgramOrderDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="report-section">
        <div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Generate Report" OnClick="GenerateReport" CssClass="button" />		
        </div>
