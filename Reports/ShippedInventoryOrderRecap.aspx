<%@ Page Language="C#" MasterPageFile="~/LumenApp.master" AutoEventWireup="true" Title="Shipped Inventory Order Recap" CodeFile="ShippedInventoryOrderRecap.aspx.cs" Inherits="Reports_ShippedInventoryOrderRecap" %>

<asp:Content ContentPlaceHolderID="Title" runat="server">
    <h2>Shipped Inventory Order Recap</h2>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="report-section">
        <div>
            ...
            <asp:DropDownList ID="ddlItemTypes" runat="server" OnSelectedIndexChanged="GenerateReport"/>            
